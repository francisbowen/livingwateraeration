        ...
        $(".wishlistForm").submit(function(e) {
            ...
            $.ajax({
                ...
                success:function(data, textStatus) {
                    ...
                    $('#loading').hide();
                    d.empty().html('<a class="btn btnProduct btnWishlistAdded added" href="' + window.wishlist_url + '"><i class="fa fa-heart-o"></i><span>Added to wishlist</span></a>');
                    btnWishlist();
...
//move html responsive
/*
shopify.responsive = Shopify.responsive || {};

shopify.responsive.current_width = $(window).width();
shopify.responsive.min_width = 768;
shopify.responsive.mobile = Shopify.responsive.current_width < Shopify.responsive.min_width;
...
function toggleMobileStyles()
{
    ...
    shopify.emit('responsive update', {
        mobile: shopify.responsive.mobile
    });
}

$(window).on('resize', function() {
    var _cw = shopify.responsive.current_width;
    var _mw = shopify.responsive.min_width;
    var _w = $(window).width();
    var _toggle = (_cw >= _mw && _w < _mw) || (_cw < _mw && _w >= _mw);
    shopify.responsive.mobile = _cw >= _mw;
    shopify.responsive.current_width = _w;
    if (_toggle) {
        toggleMobileStyles();
    }
});
...
$(document).ready(function() {
    alert("shopify.responsive.mobile");
    if (shopify.responsive.mobile) {
        toggleMobileStyles();
    }
});
